        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              @livewire('transport-form', ['societe_id'=>$societe])
            </div>
          </div>
        </div>
      <!-- ========== section start ========== -->
            ...
            <div class="col-lg-12">
              <div class="card-style mb-30">
                <div class="title d-flex flex-wrap justify-content-between">
                  <div class="left">
                    <h6 class="text-medium mb-10">Societe de Voyage</h6>
                    <h3 class="text-bold">List de Societe</h3>
                    <img src="{{asset('/image/'.$societe->image)}}" alt="logo de societe">
                  </div>
                  <div class="right">
                    <h4 class="text">Ajouter un Transport pour la societe {{$societe->name}}</h4>
                    <div class="text-center my-4">
                     <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"> Ajouter transport</button>
                    <a href="{{route('voyage.index')}}"><button class="btn btn-primary">Ajouter des voyages</button></a> 
                    </div>
